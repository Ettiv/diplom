...
import ListTodosComponent from './toDoPage/listTodosComponent/listDocumentsComponent';
                ...
                <Router>
                    <>
                        ...
                        <Switch>
                            ...
                            <AutfinticatedRoute path='/documents/:id' component={TodoComponent} />
                            <AutfinticatedRoute path='/documents' component={ListTodosComponent} />
